                    ...
                    <div class="col-12 ">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-center"><b>Testimonials</b></h3>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
                                  ...
                                  <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-primary mr-3">Post <i class="fa-solid fa-cloud-arrow-up"></i></button>
                                    ...
                                    <tr>
                                        ...
                                        <td>"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium tenet"</td>
                                        <td class="text-center">
                                            <button class="btn btn-warning mr-3">Hide <i class="fa-solid fa-eye-slash"></i></button>
                                            <a href="" class="text-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
