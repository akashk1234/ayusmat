...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 d-flex justify-content-between py-4">
                        <a href="admin-patients" class="btn btn-outline-info">Patients</a>
                    </div>
                    <div class="col-12 ">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-center"><b>Patients Registered Through Website</b></h3>
                            </div>
                            <div class="card-body">
                                <table class="table">
                                    <thead>
                                        <tr>
                                          ...
                                          <th scope="col" class="text-center">Add to patient list</th>
                                      </tr>
                                  </thead>
                                  <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="" class="text-success" data-toggle="modal" data-target=".addToPatientModal">
    ...
    <!--Add to Patient Modal start-->
    <div class="modal fade addToPatientModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content p-4">
            <form class="border p-3">
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-center">Add to patients+</h3><hr>
                    </div>
